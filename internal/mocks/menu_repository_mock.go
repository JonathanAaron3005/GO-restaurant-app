...
func (m *MockMenuRepository) CreateMenu(ctx context.Context, menu model.MenuItem) (model.MenuItem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMenuRepositoryMockRecorder) CreateMenu(ctx, menu interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMenu", reflect.TypeOf((*MockMenuRepository)(nil).CreateMenu), ctx, menu)
}
